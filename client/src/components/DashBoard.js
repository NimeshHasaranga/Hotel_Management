  ...
  return (
    <div style={styles.dashboard}>
      ...
      <div style={styles.cardContainer}>
        ...
        <Card title="Restaurant Management" content="Oversee restaurant operations" Icon={FaUtensils} />
        <Card title="Bar Management" content="Manage bar orders and inventory" Icon={FaCocktail} onClick={() => navigate('/barlogin')}  />
        <Card title="Event Management" content="Organize and track events" Icon={FaCalendarAlt} />
      </div>
    </div>
  );
};
